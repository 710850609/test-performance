...
BEGIN
    ...
    IF tmp_in_max_range = 1 THEN
        ...
        SET tmp_min_val = DATE_FORMAT(start_time, '%m');
        SET tmp_max_val = DATE_FORMAT(end_time, '%m');
    ELSE
        SET tmp_min_val = 1;
    ...
    IF tmp_in_max_range = 1 THEN
        ...
        SET tmp_min_val = DATE_FORMAT(start_time, '%d');
        SET tmp_max_val = DATE_FORMAT(end_time, '%d');
    ELSE
        SET tmp_min_val = 1;
    ...
    IF tmp_in_max_range = 1 THEN
        ...
        SET tmp_min_val = DATE_FORMAT(start_time, '%H');
        SET tmp_max_val = DATE_FORMAT(end_time, '%H');
    ELSE
        SET tmp_min_val = 0;
        SET tmp_max_val = 23;
    END IF;
...
-- 生成随机分钟
    IF tmp_in_max_range = 1 THEN
        ...
        SET tmp_min_val = DATE_FORMAT(start_time, '%i');
        SET tmp_max_val = DATE_FORMAT(end_time, '%i');
    ELSE
        SET tmp_min_val = 0;
        SET tmp_max_val = 59;
    END IF;
    ...
    IF tmp_in_max_range = 1 THEN
        ...
        SET tmp_min_val = DATE_FORMAT(start_time, '%s');
        SET tmp_max_val = DATE_FORMAT(end_time, '%s');
    ELSE
        SET tmp_min_val = 0;
        SET tmp_max_val = 59;
    END IF;
